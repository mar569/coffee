        ...
        <section className='max-w-[1920px] mx-auto'>
            <div className='container'>
                ...
                >
                    <div>
                        <h2
                            className='font-bold pt-[64px] md:pt-[100px] pb-[53px] w-[280px] md:w-full pl-4 text-[#EBF5E4]'
                            style={{
                                fontSize: '28px',
                                lineHeight: '32px',
                                textAlign: 'center',
                    ...
                    <div style={{ padding: '0 20px', maxWidth: '100%' }}>
                        <p
                            className='text-center text-[17px] md:text-[28px] leading-[16px] md:leading-[29px] text-[#EBF5E4]'
                        >
